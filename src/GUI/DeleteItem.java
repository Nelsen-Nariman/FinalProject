...
public class DeleteItem extends JFrame implements ActionListener, MouseListener{
...
//			
			...
			JOptionPane.showMessageDialog(null, "Success to delete "+ nama);
